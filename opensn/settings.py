# Django settings for opensn project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'opensn',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'qxq1&95!ph1b8y2(jtx=id4ubn735_3vtj$t!tqt)ppc-s5x#c'
...
ROOT_URLCONF = 'opensn.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'opensn.wsgi.application'
